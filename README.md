...
8. **Fase 8 (actual)** — **Onboarding ✅ (tour de primera vez + modal de atajos ⌘/), rendimiento ✅ (memo + selectores finos en NodeView), micro-interacciones ✅ (barra de estado contextual)**. Pendiente: pruebas con diseñadores.
